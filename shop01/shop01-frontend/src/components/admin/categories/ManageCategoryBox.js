...
import CreateCategoryButtonContainer from '../../../containers/admin/categories/CreateCategoryButtonContainer';
import EditCategoryButtonContainer from '../../../containers/admin/categories/EditCategoryButtonContainer';
import DeleteCategoryButtonContainer from '../../../containers/admin/categories/DeleteCategoryButtonContainer';
  ...
  return (
    <AccordionItemBlock>
      ...
      >
        ...
        <ButtonsBox>
          <CreateCategoryButtonContainer type="icon" category={category} />
          <EditCategoryButtonContainer category={category} />
          <DeleteCategoryButtonContainer category={category} />
        </ButtonsBox>
      </AccordionItemHeading>
