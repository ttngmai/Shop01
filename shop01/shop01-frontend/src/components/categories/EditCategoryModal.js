...
const EditCategoryModalBlock = styled.div`
  width: 320px;
  padding: 1.5rem;
  border-radius: 4px;
  background: white;
...
const EditCategoryModal = ({ visible, category, onCancel, onSubmit }) => {
  ...
  return (
    <Background onClick={onCancel}>
      <EditCategoryModalBlock onClick={handlePreventBubbling}>
